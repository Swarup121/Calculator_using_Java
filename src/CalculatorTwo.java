...
public class CalculatorTwo {
    public static void main(String[] args) {
        ...
        while(true){
            ...
            float operand_one = sc.nextFloat();
            float operand_two = sc.nextFloat();
